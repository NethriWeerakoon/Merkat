<%-- 
    Document   : Manageitem
    Created on : Aug 1, 2023, 11:24:13 PM
    Author     : Kavindu
--%>
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    >
                    <form
                        action="additem" method="POST" enctype="multipart/form-data"
                        class="custom-form"
                        style="
                        padding: 12px;
                        margin: 40px;
                        ...
                        <div
                            ...
                            <div
                                ...
                                style="padding-right: 12px; height: 42px"
                                >
                                <label
                            ...
                            <div
                                class="col-sm-6 input-column"
                                style="padding-right: 0px; padding-left: 12px"
                                >
                                <div class="dropdown" style="width: 400px">

                                    <select style="width: 220px; height: 35px" id="category" name="category">
                        ...
                        <div
                            ...
                            <div class="col-sm-6 input-column">
                                <textarea class="form-control" name="description" style="height: auto"></textarea>
                            </div>
                        </div>
                        <div
                            class="row form-group"
