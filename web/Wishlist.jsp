<%-- 
    Document   : Wishlist
    Created on : Aug 2, 2023, 1:35:42 AM
    Author     : Kavindu
--%>
...
<html data-bs-theme="light" lang="en">
    ...
    <body style="background: rgb(21, 116, 146)">
            ...
            <div class="container">
                ...
                <div
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="addtocart.jsp" style="padding: 0px"
                               ><svg
        ...
        <div class="container" style="height: auto">
            <div style="margin: 12px; background: #ffffff">
                <h1
                    style="
                    text-align: center;
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img
                                ...
                                width="200"
                                height="143"
                                src="img/items/<%= resultSet.getString("wimage")%>"
                                />
                        </div>

                        <div class="col" style="margin-right: 10px; height: auto">
                            <h4 style="font-family: 'Abyssinica SIL', serif">
                                <% out.print(resultSet.getString("wname"));  %>
                            </h4>

                        </div>
                        <div class="col"><p>Rs.<% out.print(resultSet.getString("wprice"));  %></p></div>
                    </div>
