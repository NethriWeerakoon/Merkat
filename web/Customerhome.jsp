<%-- 
    ...
    Created on : Aug 2, 2023, 12:30:03 AM
    Author     : Kavindu
--%>
            ...
            <div class="container">
                ...
                <div
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="addtocart.jsp" class="nav-link" style="padding: 0px"
                               ><svg
                ...
                <div
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="style1" href="#"
                                   ><h5 class="card-title" style="font-family: Amethysta, serif; text-align: center">
                                        <%
