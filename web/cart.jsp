<%-- 
    Document   : cart
    Created on : Aug 10, 2023, 3:45:57 PM
    Author     : Kavindu
--%>
...
<%
    if (request.getParameter("pid") != null) {
        ...
        String query2 = "INSERT INTO cart (cpname,cprice,cimage) VALUES (?,?,?)";
        PreparedStatement pstmt2 = con.prepareStatement(query2);
        pstmt2.setString(1, cpname);
        pstmt2.setString(2, cprice);
        pstmt2.setString(3, cimage);
