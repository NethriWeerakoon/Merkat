<%-- 
    Document   : order
    Created on : Aug 10, 2023, 6:37:55 PM
    Author     : Kavindu
--%>
...
<%
    ...
    if (product_id != null) {
        String query = "SELECT product_id, pname,price,image FROM product WHERE product_id = ?";
    ...
    <body>
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="col" style="margin-right: 10px; margin-top: 36px; height: auto">
                            <!--                            <p style="font-family: 'Abyssinica SIL', serif">
                                                            
                                                        </p>-->
                            <p style="font-family: 'Abyssinica SIL', serif; font-size: 24px" >
                                <%= pname%>
                            </p>
                            <!--                            <div
                                                            style="text-align: left; margin-top: 12px; margin-bottom: 6px; font-size: 24px"
                                                            >
                                                            
                                                        </div>-->
                        </div>
                        <div class="col" style=" font-size: 22px; margin-top: 36px;"><p>Rs.<%= price%></p></div>
                    </div>
                </div>
                <div
        ...
        <div class="container" style="margin-top: 15px">
            <div class="row" style="width: 500px">
                <div class="col-md-6"><strong>We accept</strong></div>
                <div class="col-md-6"><img src="img/accepted_cards.png" /></div>
            </div>
        </div>
        <!-- End: 1 Row 2 Columns --><!-- Start: 1 Row 1 Column -->
        <div class="container" style="margin-top: 12px">
            <div class="row">
                <div class="col-md-12"><strong>Payment method</strong></div>
            </div>
        </div>
        <!-- End: 1 Row 1 Column --><!-- Start: 1 Row 2 Columns -->
        <div class="container" style="width: 500px; margin-top: 12px">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-check">
                        <input
                            ...
                            type="radio"
                            id="formCheck-1"
                            style="background: var(--bs-dark-border-subtle)"
        ...
        <div class="container" style="margin-top: 12px">
            <div class="row">
                <div
                    ...
                    <%
                        out.println("<a href='buyorder.jsp?total=" + price + "'>"
                                + "<button class='btn btn-primary' type='submit' name='buyorder' style='color: var(--bs-tertiary-bg); background: rgb(15, 95, 120); height: 45px; width: auto; border-style: none;'>Order Your Product</button></a>");
                    %>


                    <%
//                                out.println("<a href='buyorder.jsp?subtotal=" + price + "'>"
//                                        + "<button class='btn btn-primary' type='submit' name='buyorder' style='color: var(--bs-tertiary-bg); background: rgb(15, 95, 120); height: 45px; width: auto; border-style: none;'>Order Your Product</button></a>");
//                            
                    %>
        ...
        <!-- End: 1 Row 1 Column -->
        <div class="container text-muted py-4 py-lg-5" style="text-align: center">
