<%-- 
    ...
    Created on : Aug 2, 2023, 12:44:33 AM
    Author     : Kavindu
--%>
...
<html data-bs-theme="light" lang="en">
    <head>
        ...
        <link
            ...
            />
        <link rel="stylesheet" href="styles/editcustomerprofile.css" />
    </head>
...
//                                System.out.println("email" + email);
                            ...
                            if (fname1 != null && lname1 != null && number1 != null && address1 != null && email1 != null ) {
                                ...
                                try {
                                    ...
                                    String query = "UPDATE buyer SET fname=?, lname=?, number=?, address=?, email=? WHERE buyer_id=?";
                                    ...
                                    preparedStatement.setString(6, buyer_id);
                                    ...
                                    response.sendRedirect("editcustomerprofile.jsp");
        ...
        <div style="background: var(--bs-body-bg)">
            ...
            <footer class="text-center">
                <div class="container text-muted py-4 py-lg-5">
                    ...
                    <p class="mb-0">Copyright ©️ 2023 Mercat</p>
                </div>
            </footer>
            <!-- End: Footer Basic -->
        </div>
