<%-- 
    ...
    Created on : Aug 4, 2023, 5:46:14 PM
    Author     : Kavindu
--%>
...
<html data-bs-theme="light" lang="en">
    <head>
        ...
        <link
            ...
            />
        <link rel="stylesheet" href="styles/sellerlogin.css" />
    </head>
    <body>
        ...
        <!-- End: Navbar Right Links --><!-- Start: Login Form Basic -->
            ...
            <div class="container">
                <div class="row mb-5" style="margin-right: 0px; margin-left: 0px">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        ...
                        <p
                            class="w-lg-50"
                            style="height: 30px; font-size: 20px; margin-bottom: 12px"
                            >
                            Seller Login
                        </p>
                    </div>
                ...
                <div
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div
                            class="card mb-5"
                            style="border-style: none; border-radius: 1px"
                            >
                            <div
                                ...
                                <form class="text-center" method="post" style="width: 220px">
                                    <div class="mb-3">
                                        <input
                                            class="form-control"
                                            type="text"
