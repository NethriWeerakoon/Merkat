<%-- 
    ...
    Created on : Aug 6, 2023, 12:27:10 AM
    Author     : Kavindu
--%>
...
<html data-bs-theme="light" lang="en">
    <head>
        ...
        <link
            ...
            />
        <link rel="stylesheet" href="styles/editsellerprofile.css" />
    </head>
    <body style="background: rgb(21, 116, 146)">
        ...
        <!-- End: Navbar Right Links --><!-- Start: Profile Edit Form -->
        <div
...
//                        
            ...
            <div
                ...
                <div class="col" style="width: auto; height: auto">
                    <form action="editsellerprofile.jsp" method="POST"
                        class="rf-input-container"
                        style="text-align: center; width: auto; padding: 0px"
                        >
                        <div
                            class="row"
                            style="
                            ...
                            "
                            >
                            <div class="col-md-6" style="width: 200px; height: auto">
                                <p
                                    style="
                                    width: 160px;
                                    height: auto;
