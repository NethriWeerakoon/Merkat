<%-- 
    ...
    Created on : Aug 5, 2023, 4:33:48 PM
    Author     : Kavindu
--%>
...
<html data-bs-theme="light" lang="en">
  <head>
    ...
    />
    <title>admin homewithlogin</title>
    <link
      rel="stylesheet"
  ...
  <body>
      ...
      <div class="container">
        ...
        >
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"></li>
            <li class="nav-item">
              <a class="nav-link" href="#" style="padding: 0px"></a>
            </li>
            <li class="nav-item"></li>
            <li class="nav-item"></li>
            <li class="nav-item"></li>
    ...
    >
      <h1
        ...
        "
      >
        Welcome to MERKAT Administration
      </h1>
    </div>
    <div
      style="
