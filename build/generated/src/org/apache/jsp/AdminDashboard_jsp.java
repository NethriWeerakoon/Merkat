...
public final class AdminDashboard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body style=\"background: rgb(195, 214, 218)\">\n");
      ...
      out.write("        <div style=\"height: auto; margin-bottom: 0px\">\n");
      out.write("            <!-- Start: seller_table -->\n");
      out.write("            <div\n");
      out.write("                style=\"\n");
...
//                                        out.println("<td><button onclick=\"window.location.href='updateproduct.jsp?id=" + seller_id + "';\" class=\"btn btn-primary\" type=\"button\" style=\"padding-top: 6px; padding-right: 12px; margin-right: 0px; margin-left: 0px; border-radius: 6px 0px 0px 6px; border-top-right-radius: 6px; border-bottom-right-radius: 6px;width: auto;\">Delete</button></td>");
      ...
      out.write("\n");
      out.write("                            <!--                        <script>\n");
      out.write("                                                                                function deleteSeller(seller_id) {\n");
      out.write("                                                                                    if (confirm(\"Are you sure you want to delete this seller?\")) {\n");
      out.write("                                                                                        // Send an AJAX request to the server to perform the delete operation\n");
      out.write("                                                                                        var xhr = new XMLHttpRequest();\n");
      out.write("                                                                                        xhr.onreadystatechange = function () {\n");
      out.write("                                                                                            if (xhr.readyState === 4) {\n");
      out.write("                                                                                                if (xhr.status === 200) {\n");
      out.write("                                                                                                    // Reload the page to reflect the changes after deletion\n");
      out.write("                                                                                                    location.reload();\n");
      out.write("                                                                                                } else {\n");
      out.write("                                                                                                    alert(\"Error occurred while deleting the seller.\");\n");
      out.write("                                                                                                }\n");
      out.write("                                                                                            }\n");
      out.write("                                                                                        };\n");
      out.write("                                                                                        xhr.open(\"POST\", \"delete_seller.jsp?seller_id=\" + seller_id, true);\n");
      out.write("                                                                                        xhr.send();\n");
      out.write("                                                                                    }\n");
      out.write("                                                                                }\n");
      out.write("                                                    </script>-->\n");
      ...
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            <!-- End: seller_table --><!-- Start: buyer_table -->\n");
      out.write("            <div\n");
      out.write("                style=\"\n");
      out.write("                width: auto;\n");
      out.write("                height: auto;\n");
      ...
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            <!-- End: buyer_table --><!-- Start: product_table -->\n");
      out.write("            <div\n");
      out.write("                style=\"width: auto; height: auto; margin-top: 0px; margin-bottom: 0px\"\n");
      out.write("                >\n");
      out.write("                <div\n");
      out.write("                    class=\"table-responsive\"\n");
      out.write("                    style=\"\n");
